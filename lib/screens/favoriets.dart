          ...
          child:
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                                  final favorite = cubit.favorites[index];
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        children: [
                          ...
                          MaterialButton(
                            onPressed: () {
                             BlocProvider.of<LayoutCubit>(context).deleteFavorite(
                                  productId:
                                      cubit.favorites[index].id.toString());
                            },
                            child: Text("Remove"),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<LayoutCubit, LayoutStates>(
      ...
      builder: ((context, state) {
        print(cubit.favorietsID.length);
        return Scaffold(
          body: Padding(
